      ...
      <div className="container-px relative z-10 mx-auto max-w-3xl py-24 text-center text-white">
        ...
        <Reveal delay={0.06}>
          <h1 className="mx-auto mt-6 max-w-2xl text-balance text-5xl font-bold leading-[0.98] sm:text-6xl md:text-7xl">
            Set sail on a real pirate ship
          </h1>
        </Reveal>

        <Reveal delay={0.12}>
          <p className="mx-auto mt-6 max-w-xl text-lg text-white/85">
            Climb aboard our traditional wooden schooner for reef snorkeling, an open
            bar and a sunset that turns the whole sky pink over Aruba&apos;s turquoise
            coast.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.26}>
          <div className="mx-auto mt-14 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2.5 backdrop-blur">
            ...
            <span className="text-sm text-white/80">snorkel sites visited, from calm reef to WWII shipwreck</span>
          </div>
        </Reveal>
      </div>
    </section>
