...
export const metadata: Metadata = {
  title: afternoonPirateContent.nl.metaTitle,
  description: afternoonPirateContent.nl.metaDescription,
};

export default function AfternoonPiratePartyPageNl() {
  return <AfternoonPiratePartyPage locale="nl" />;
}
